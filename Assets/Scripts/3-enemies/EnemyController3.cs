...
[RequireComponent(typeof(ToBlue))]
[RequireComponent(typeof(ToRed))]
public class EnemyController3: StateMachine {
    ...
    private ToBlue change2Blue;
    private ToRed change2Red;
    ...
    private void Awake() {
        ...
        change2Red = GetComponent<ToRed>();
        change2Blue = GetComponent<ToBlue>();
        // base
        ...
        base
        .AddState(patroller)     // This would be the first active state.
        .AddTransition(patroller, () => DistanceToTarget()<=radiusToWatch,   change2Red)
        .AddTransition(change2Red,   () => DistanceToTarget()>radiusToWatch,   change2Blue)
        .AddTransition(change2Blue, () => DistanceToTarget()<=radiusToWatch,   change2Red)
        ;
